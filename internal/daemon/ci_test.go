...
func TestPRPollRenudgesFailingCIOnScheduleAndEscalatesAfterMax(t *testing.T) {
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "initial CI poll cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "first deferred CI poll cycle completion")
	waitFor(t, "first repeated failing CI poll", func() bool {
		return deps.commands.countCall("gh", "pr", "checks", "42", "--json", "bucket") == 2
	})
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "scheduled second CI nudge cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "second deferred CI poll cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "scheduled third CI nudge cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "third deferred CI poll cycle completion")
	waitFor(t, "third repeated failing CI poll", func() bool {
		return deps.commands.countCall("gh", "pr", "checks", "42", "--json", "bucket") == 6
	})
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "CI escalation cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "passing CI recovery poll cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "failing CI nudge after reset cycle completion")
...
func TestPRPollRetriesCINudgeAfterSendKeysFailure(t *testing.T) {
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "failed CI nudge attempt cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "retried CI nudge cycle completion")
...
func TestPRPollRetriesScheduledCIRenudgeAfterSendKeysFailure(t *testing.T) {
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "initial scheduled CI nudge cycle completion")
	waitFor(t, "initial CI nudge", func() bool {
		return deps.amux.countKey("pane-1", expectedCINudgePrompt(42)+"\n") == 1 &&
			deps.commands.countCall("gh", "pr", "checks", "42", "--json", "bucket,name,link") == 1 &&
			deps.events.countType(EventWorkerNudgedCI) == 1
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "deferred scheduled re-nudge cycle completion")
	waitFor(t, "deferred scheduled re-nudge", func() bool {
		return deps.commands.countCall("gh", "pr", "checks", "42", "--json", "bucket") == 2
	})

	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "failed scheduled re-nudge cycle completion")
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "retried scheduled re-nudge cycle completion")
