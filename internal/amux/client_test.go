...
func TestCLIClientSpawn(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantCmds: []recordedCommand{
				{name: "/usr/local/bin/amux", args: []string{"-s", "override-session", "spawn", "--auto", "--at", "lead-pane", "--name", "clone-01"}},
		...
		},
		{
			...
			wantCmds: []recordedCommand{
				{name: "amux", args: []string{"-s", "default", "spawn", "--auto", "--at", "lead-pane", "--name", "worker-2"}},
		...
		},
		{
			...
			wantCmds: []recordedCommand{
				{name: "amux", args: []string{"-s", "default", "spawn", "--auto", "--root", "--name", "worker-implicit"}},
		...
		},
		{
			...
			wantCmds: []recordedCommand{
				{name: "amux", args: []string{"-s", "main", "spawn", "--auto", "--at", "lead-pane", "--name", "w-LAB-99"}},
		...
		},
		{
			...
			wantCmds: []recordedCommand{
				{name: "amux", args: []string{"-s", "default", "spawn", "--auto", "--at", "lead-pane", "--name", "worker-3"}},
			},
		...
		},
		{
			...
			wantCmds: []recordedCommand{
				{name: "amux", args: []string{"-s", "default", "spawn", "--auto", "--at", "lead-pane", "--name", "worker-4"}},
			},
...
func TestCLIClientSpawnDoesNotInspectSessionLayout(t *testing.T) {
	...
	wantCmds := []recordedCommand{
		{name: "amux", args: []string{"-s", "orca-dev", "spawn", "--auto", "--at", "lead-pane", "--name", "clone-01"}},
...
func TestCLIClientSpawnCleansUpByStablePaneRefOnSetupFailure(t *testing.T) {
	...
	wantCmds := []recordedCommand{
		{name: "amux", args: []string{"-s", "orca-dev", "spawn", "--auto", "--root", "--name", "w-LAB-901"}},
