...
func TestPRReviewPollingEscalatesAfterThreeNudgesAndResetsAfterApprovalCycle(t *testing.T) {
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "review escalation poll cycle completion")
...
func TestPRReviewPollingNotifiesCallerPaneWhenReviewNudgesAreExhausted(t *testing.T) {
	...
	tickAndWaitForHeartbeat(t, d, deps, prTicker, adaptivePRFastPollInterval, "lead escalation poll cycle completion")
