...
func TestPRReviewPollingSkipsInlineCommentLookupWhenReviewSnapshotIsUnchanged(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			deps.commands.queue("gh", []string{"pr", "view", "42", "--json", prSnapshotJSONFields}, `{"mergedAt":null,"state":"OPEN","closedAt":null,"mergeable":"MERGEABLE","mergeStateStatus":"CLEAN","updatedAt":"2026-04-02T09:00:00Z","reviewDecision":"CHANGES_REQUESTED","reviews":[],"comments":[]}`, nil)
...
func TestPRReviewPollingEmitsApprovalAfterSkippingInlineCommentLookup(t *testing.T) {
	...
	deps.commands.queue("gh", []string{"pr", "view", "42", "--json", prSnapshotJSONFields}, `{"mergedAt":null,"state":"OPEN","closedAt":null,"mergeable":"MERGEABLE","mergeStateStatus":"CLEAN","updatedAt":"2026-04-02T09:00:00Z","reviewDecision":"CHANGES_REQUESTED","reviews":[],"comments":[]}`, nil)
	deps.commands.queue("gh", []string{"pr", "view", "42", "--json", prSnapshotJSONFields}, `{"mergedAt":null,"state":"OPEN","closedAt":null,"mergeable":"MERGEABLE","mergeStateStatus":"CLEAN","updatedAt":"2026-04-02T09:00:00Z","reviewDecision":"CHANGES_REQUESTED","reviews":[],"comments":[]}`, nil)
	deps.commands.queue("gh", []string{"pr", "view", "42", "--json", prSnapshotJSONFields}, `{"mergedAt":null,"state":"OPEN","closedAt":null,"mergeable":"MERGEABLE","mergeStateStatus":"CLEAN","updatedAt":"2026-04-02T09:02:00Z","reviewDecision":"APPROVED","reviews":[],"comments":[]}`, nil)
	deps.commands.queue("gh", []string{"pr", "checks", "42", "--json", "bucket"}, `[{"bucket":"pending"}]`, nil)
	deps.commands.queue("gh", []string{"pr", "checks", "42", "--json", "bucket"}, `[{"bucket":"pending"}]`, nil)
	deps.commands.queue("gh", []string{"pr", "checks", "42", "--json", "bucket"}, `[{"bucket":"pending"}]`, nil)
