...
CREATE TABLE IF NOT EXISTS events (
	...
	`ALTER TABLE IF EXISTS tasks ADD COLUMN IF NOT EXISTS pr_repo TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE IF EXISTS merge_queue ADD COLUMN IF NOT EXISTS mode TEXT NOT NULL DEFAULT 'pr'`,
	`ALTER TABLE IF EXISTS merge_queue ADD COLUMN IF NOT EXISTS target TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE IF EXISTS merge_queue ADD COLUMN IF NOT EXISTS branch TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE IF EXISTS merge_queue ADD COLUMN IF NOT EXISTS clone_path TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE IF EXISTS merge_queue ADD COLUMN IF NOT EXISTS base_branch TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE IF EXISTS merge_queue ADD COLUMN IF NOT EXISTS quality_gate TEXT NOT NULL DEFAULT ''`,
	...
	`ALTER TABLE IF EXISTS clones ADD COLUMN IF NOT EXISTS failure_count INTEGER NOT NULL DEFAULT 0`,
