...
func TestDaemonStartReconcilesNonTerminalAssignments(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:              "starting worker escalates when pane liveness check errors",
			taskStatus:       TaskStatusStarting,
			paneID:           "pane-1",
		...
		{
			name:              "starting worker escalates when pane capture errors",
			taskStatus:       TaskStatusStarting,
			paneID:           "pane-1",
		...
		{
			name:              "starting worker escalates when pane is missing",
			taskStatus:       TaskStatusStarting,
			paneID:           "pane-1",
		...
		{
			name:             "starting worker fails when pane already exited",
			taskStatus:       TaskStatusStarting,
			paneID:           "pane-1",
